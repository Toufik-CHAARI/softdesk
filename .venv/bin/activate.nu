...
let virtual-env = "/Users/chaaritoufik/Desktop/dev/OPENCLASSROOM/PROJET7/softdesk/.venv"
let bin = "bin"
let path-sep = ":"
...
let virtual_prompt = (if ("(softdesk) " != "") {
    "((softdesk) ) "
} {
...
alias deactivate = source "/Users/chaaritoufik/Desktop/dev/OPENCLASSROOM/PROJET7/softdesk/.venv/bin/deactivate.nu"
